...
using BLL = SENAME.Senainfo.ModFichaIndividual.BLL.Impl;
    ...
    public partial class FichaIndividual : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        idusuario_conect.Value = Session["IdUsuario"].ToString();
                ...
                //Session["IdUsuario"] = "96040"; //"57085"; //47468";// "69368"; //"69368"; // "50328"; //"47468"; //"69368"  
                //idusuario_conect.Value = Session["IdUsuario"].ToString();
                ...
                hdnCodNino.Value = Cod_Nino;
                hdnCodProyecto.Value = Cod_Proy;
        ...
        private void CargarDatosGenerales(string codNino, string codProyecto)
        {
            ...
            if(datosGeneralesDTO != null)
            {
                ...
                txtRit.Value = datosGeneralesDTO.Rit;
                txtOtrosRit.Value = datosGeneralesDTO.OtrosRit;
                txtTribunal.Value = datosGeneralesDTO.Tribunal;
                txtOtroTribunal.Value = datosGeneralesDTO.OtroTribunal;
                txtFechaVisita.Value = datosGeneralesDTO.FechaVisita;
                txtHoraVisita.Value = datosGeneralesDTO.HoraVisita;
                txtJuezVisitador.Value = datosGeneralesDTO.JuezVisitador;
                txtConsejeroTecnico.Value = datosGeneralesDTO.ConsejeroTecnico;
                txtNombreNino.Value = datosGeneralesDTO.NombreMenor;
                txtRutNino.Value = datosGeneralesDTO.Rut;
                txtFilacion.Value = datosGeneralesDTO.Filiacion;
                txtSexoNino.Value = datosGeneralesDTO.SexoMenor;
                txtFechaNacimientoNino.Value = datosGeneralesDTO.FechaNacimiento;
                txtEdadNino.Value = datosGeneralesDTO.EdadMenor;
                txtNacionalidadNino.Value = datosGeneralesDTO.Nacionalidad;
                txtPasaporteNino.Value = datosGeneralesDTO.Pasaporte;
                txtCodNino.Value = datosGeneralesDTO.CodNino;
                txtNombreProyecto.Value = datosGeneralesDTO.NombreProyecto;
                txtComunaProyecto.Value = datosGeneralesDTO.ComunaProyecto;
                txtTipoProyecto.Value = datosGeneralesDTO.TipoProyecto;
                txtNombreMadre.Value = datosGeneralesDTO.NombreMadre;
                txtRutMadre.Value = datosGeneralesDTO.RutMadre;
                txtDireccionMadre.Value = datosGeneralesDTO.DireccionMadre;
                txtEstadoMadre.Value = datosGeneralesDTO.EstadoMadre;
                txtNacionalidadMadre.Value = datosGeneralesDTO.NacionalidadMadre;
                txtPasaporteMadre.Value = datosGeneralesDTO.PasaporteMadre;
                txtNombrePadre.Value = datosGeneralesDTO.NombrePadre;
                txtRutPadre.Value = datosGeneralesDTO.RutPadre;
                txtDireccionPadre.Value = datosGeneralesDTO.DireccionPadre;
                txtEstadoPadre.Value = datosGeneralesDTO.EstadoPadre;
                txtNacionalidadPadre.Value = datosGeneralesDTO.NacionalidadPadre;
                txtPasaportePadre.Value = datosGeneralesDTO.NumPasaportePadre;
                txtComunaResidencia.Value = datosGeneralesDTO.ComunaResidente;
                txtAyudaComunal.Value = datosGeneralesDTO.CualAyudaComunal;
                txtCuales.Value = datosGeneralesDTO.CualAyudaComunal;
                txtApoyoComunitario.Value = datosGeneralesDTO.ApoyoComunitario;
                txtChileSolidario.Value = datosGeneralesDTO.ChileSolidario;
                txtChileCrece.Value = datosGeneralesDTO.ChileCrece;
                txtFps.Value = datosGeneralesDTO.Fps;
                txtPuntaje.Value = datosGeneralesDTO.Puntaje;
                txtFechaAplicacion.Value = datosGeneralesDTO.FechaAplicacion;
                txtAbriendoCaminos.Value = datosGeneralesDTO.AbriendoCaminos;
                txtOtros.Value = datosGeneralesDTO.OtrosMenor;
                txtObsGenerales.Value = datosGeneralesDTO.ObservMenor;
                txtCitaAudiencia.Value = datosGeneralesDTO.CitaAudiencia;
                txtAudienciaInmediata.Value = datosGeneralesDTO.AudienciaInmediata;
                txtObservSugTribunal.Value = datosGeneralesDTO.SugerenciasAlTribunal;
                txtObservSugSename.Value = datosGeneralesDTO.SugerenciasAlSename;
        ...
        private void CargarDatosProcesales(string codNino)
        {
            ...
            {
                /****************** Antecedentes generales **********************/
                txtFechaIngresoActual.Value = datosProcesalesDTO.FecIngresoEfectiva;
                txtFechaPrimerIngreso.Value = datosProcesalesDTO.FecIngresoSistema;
                txtFechaUltimaMedida.Value = datosProcesalesDTO.FecUltMedida;
                txtClaseMedida.Value = datosProcesalesDTO.ClaseMedida;
                txtDuracionMedida.Value = datosProcesalesDTO.DuracionUltMedida;
                txtRequirente.Value = datosProcesalesDTO.RequitenteMedidaProteccion;
                txtHnosEnSistema.Value = datosProcesalesDTO.HermanoSis;
                txtHnosFueraSistema.Value = datosProcesalesDTO.HermanoFueraSis;
                txtHnosEnSistemaR.Value = datosProcesalesDTO.HnosResidencia;
                txtEscuchado.Value = datosProcesalesDTO.NiñoEscuchadoPorElJuez;
                txtFechaUltimaEntrevista.Value = datosProcesalesDTO.FecUltimaEntrevista;
                txtObsProcesales.Value = datosProcesalesDTO.ObservProcesal;
        ...
        private void CargarCausales(string causal)
        {
            ...
            foreach(string causalObj in listaCausales)
            {
                ...
                {
                    case "1": // Maltrato
                        causal1.Checked = true;
                        break;
                    case "2": // Transgresión
                        causal2.Checked = true;
                        break;
                    case "3": // Explotación
                        causal3.Checked = true;
                        break;
                    case "4": // Abandono
                        causal4.Checked = true;
                        break;               
                    case "01": // Consumo Droga
                        causal5.Checked = true;
                        break;
                    case "02": // Consumo Alcohol
                        causal6.Checked = true;
                        break;
                    case "03": // Falta Habilidades
                        causal7.Checked = true;
                        break;
                    case "04": // Situación de calle
                        causal8.Checked = true;
                        break;
                    case "05": // Negligencia
                        causal9.Checked = true;
                        break;
                    case "06": // Trastornos Salud
                        causal10.Checked = true;
                        break;
                    case "07": // Testigo VIF
                        causal11.Checked = true;
                        break;
                    case "08": // PFTI
                        causal12.Checked = true;
                        break;
                }
            }
        }
        ...
        private void CargarSituacionFamiliar(string codNino)
        {
            ...
            if (situacionFamiliarDTO != null)
            {
                ...
                txtTrabajoEgreso.Value = situacionFamiliarDTO.ExisteTrabajoEgreso;
                txtDesdeCuando.Value = situacionFamiliarDTO.TrabajoDesde;
                txtComunaSitFam.Value = situacionFamiliarDTO.Comuna;
                txtRealizaTrabajo.Value = situacionFamiliarDTO.QuienRealizaTrabajo;
                txtObservSitFam.Value = situacionFamiliarDTO.Observacion;
            }
        }

        #endregion

        #region Detalle de Visitas

        private void CargarAntecedentesVisitas(string codNino)
        {
            var _antecedentesVisitasSenameImpl = new BLL.Impl.AntecedentesVisitasSenameImpl();
            var datosVisitasDTO = _antecedentesVisitasSenameImpl.ObtenerAntecedentesVisita(Int32.Parse(codNino));
            if (datosVisitasDTO != null)
            {
                /****************** Antecedentes Visitas **********************/
                txtRecibeVisitas.Value = (datosVisitasDTO.RecibeVisitas ? "Si" : "No");
                txtSalidaPernoctacion.Value = (datosVisitasDTO.RecibeVisitas ? "Si" : "No");
        ...
        private void CargarProcesoIntervencion(string codNino)
        {
            ...
            {
                txtEvalDiagnosticada.Value = datosProcesoDTO.EvaluacionDiagnosticada;
                txtConclusionDiagnostico.Value = datosProcesoDTO.ConclusionDiagnostico;
                txtObjetivoPlanInterv.Value = datosProcesoDTO.ObjetivoPlan;
                txtRestituir.Value = datosProcesoDTO.PosibilidadRestitucion;
                txtFechaUltimoInforme.Value = datosProcesoDTO.FechaUntimoInforme;
                txtConclusionInforme.Value = datosProcesoDTO.ConclusionInforme;
                txtIntervEpecializada.Value = datosProcesoDTO.IntervencionEspecializada;
                txtRealizaIntervencion.Value = datosProcesoDTO.InterventorEspecialista;
            }
        }
        ...
        [WebMethod]
        public static List<DTO.MaltratoIntraResidencialDto> ObtenerDatosMaltrato(string codnino)
        {
            BLL.Impl.MaltratoIntraResidencialImpl maltratoIntraResidencialImpl = new BLL.Impl.MaltratoIntraResidencialImpl();
            var result = maltratoIntraResidencialImpl.ObtenerMaltratoIntraResidencial(Int32.Parse(codnino));
            return result;
        }

        [WebMethod]
        public static List<DTO.CasoAgresorDto> ObtenerDatosAgresor(string codnino)
        {
            BLL.Impl.CasoAgresorImpl casoAgresorImpl = new BLL.Impl.CasoAgresorImpl();
            var result = casoAgresorImpl.ObtenerCasoAgresor(Int32.Parse(codnino));
            return result;
        }

        [WebMethod]
        public static List<DTO.MedidaImplementadaDto> ObtenerDatosMedidas(string codnino)
        {
            BLL.Impl.MedidaImplementadaImpl medidaImpl = new BLL.Impl.MedidaImplementadaImpl();
            var result = medidaImpl.ObtenerMedidaImplementada(Int32.Parse(codnino));
            return result;
        }
        ...
        private void CargarAntecedentesSalud(string codNino)
        {
            var _antecedentesSaludImpl = new BLL.Impl.AntecedentesSaludImpl();
            ...
            if (antecedentesSaludDTO != null)
            {
                ...
                txtInscritoConsultorio.Value = antecedentesSaludDTO.InscritoConsultorio;
                txtFechaUltControl.Value = antecedentesSaludDTO.FechaUltimoControl;
                txtDiagnostico.Value = antecedentesSaludDTO.EnfermedadCronicaDiagnosticada;
                txtCronica.Value = antecedentesSaludDTO.EnfermedadCronica;
                txtTratamiento.Value = antecedentesSaludDTO.RecibeTratamiento;                
                txtSaludMental.Value = antecedentesSaludDTO.ProblemaSaludMental;
                txtDiagnosticado.Value = antecedentesSaludDTO.Diagnosticado;
                txtTratamientoDiagnostico.Value = antecedentesSaludDTO.TratamientoDiagnostico;
                txtTieneDiscapacidad.Value = antecedentesSaludDTO.TieneDiscapacidad;
                txtTratadoPor.Value = antecedentesSaludDTO.TratadoPor;
                txtTratamientoDiscapacidad.Value = antecedentesSaludDTO.RecibeTratamientoDis;
                txtRegistroDiscapacidad.Value = antecedentesSaludDTO.RegistroDiscapacidad;
                txtTipoDiscapacidad.Value = antecedentesSaludDTO.TipoDiscapacidad;
                txtNivelDiscapacidad.Value = antecedentesSaludDTO.NivelDiscapacidad;
                txtObsDiscapacidad.Value = antecedentesSaludDTO.Observacion;
            }
        }
        ...
        private void CargarAntecedentesConsumo(string codNino)
        {
            ...
            {
                /****************** Antecedentes de Consumo **********************/
                txtConsumeDrogas.Value = antecedentesConsumoDTO.ConsumeDrogas;
                txtTipoDroga.Value = antecedentesConsumoDTO.TipoDroga;
                txtTipoConsumo.Value = antecedentesConsumoDTO.TipoConsumo;
                txtTieneEvaluacion.Value = antecedentesConsumoDTO.TieneEvaluacion;
                txtTieneTratamiento.Value = antecedentesConsumoDTO.TieneTratamiento;
                txtTieneRehabilitacion.Value = antecedentesConsumoDTO.TieneRehabilitacion;
                txtInstitucionRehab.Value = antecedentesConsumoDTO.InstitucionTratamiento;
                txtConclusiones.Value = antecedentesConsumoDTO.ConclusionUltimoInforme;
                txtObservConsumo.Value = antecedentesConsumoDTO.Observacion;
            }
        }
        ...
        private void CargarAntecedentesEscolares(string codNino)
        {
            ...
            if (antecedentesEscolaresDTO != null)
            {
                ...
                txtCursoActual.Value = antecedentesEscolaresDTO.CursoActual;
                txtUltimoCurso.Value = antecedentesEscolaresDTO.UltimoCursoAprobado;
                txtUltimoAgnoAprobado.Value = antecedentesEscolaresDTO.AnioUltimoCursoAprobado;
                txtAsistenciaEscolar.Value = antecedentesEscolaresDTO.AsistenciaEscolar;
                txtRazonInasistencia.Value = antecedentesEscolaresDTO.RazonInasistencia;
                txtPresentaRetraso.Value = antecedentesEscolaresDTO.PresentaRetraso;
                txtNivelDiferencial.Value = antecedentesEscolaresDTO.NivelDiferencial;
                txtObservEducacion.Value = antecedentesEscolaresDTO.Observacion;
                txtEscEne.Value = antecedentesEscolaresDTO.EneroAsistencia.ToString();
                txtEscFeb.Value = antecedentesEscolaresDTO.FebreroAsistencia.ToString();
                txtEscMar.Value = antecedentesEscolaresDTO.MarzoAsistencia.ToString();
                txtEscAbr.Value = antecedentesEscolaresDTO.AbrilAsistencia.ToString();
                txtEscMay.Value = antecedentesEscolaresDTO.MayoAsistencia.ToString();
                txtEscJun.Value = antecedentesEscolaresDTO.JunioAsistencia.ToString();
                txtEscJul.Value = antecedentesEscolaresDTO.JulioAsistencia.ToString();
                txtEscAgo.Value = antecedentesEscolaresDTO.AgostoAsistencia.ToString();
                txtEscSep.Value = antecedentesEscolaresDTO.SeptiembreAsistencia.ToString();
                txtEscOct.Value = antecedentesEscolaresDTO.OctubreAsistencia.ToString();
                txtEscNov.Value = antecedentesEscolaresDTO.NoviembreAsistencia.ToString();
                txtEscDic.Value = antecedentesEscolaresDTO.DiciembreAsistencia.ToString();
                txtEscTotal.Value = (antecedentesEscolaresDTO.EneroAsistencia + antecedentesEscolaresDTO.FebreroAsistencia +
