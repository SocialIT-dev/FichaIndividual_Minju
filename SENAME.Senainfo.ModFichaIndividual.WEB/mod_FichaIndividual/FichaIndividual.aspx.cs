    ...
    public partial class FichaIndividual : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                this.hdnCodNino.Value = Cod_Nino;
                this.hdnCodProyecto.Value = Cod_Proy;
        ...
        private void CargarDatosGenerales(string codNino, string codProyecto)
        {
            ...
            if(datosGeneralesDTO != null)
            {
                ...
                this.txtCodNino.Value = datosGeneralesDTO.CodNino;
                this.txtNombreProyecto.Value = datosGeneralesDTO.NombreProyecto;
                this.txtComunaProyecto.Value = datosGeneralesDTO.ComunaProyecto;
                this.txtTipoProyecto.Value = datosGeneralesDTO.TipoProyecto;
                this.txtNombreMadre.Value = datosGeneralesDTO.NombreMadre;
                this.txtRutMadre.Value = datosGeneralesDTO.RutMadre;
                this.txtDireccionMadre.Value = datosGeneralesDTO.DireccionMadre;
                this.txtEstadoMadre.Value = datosGeneralesDTO.EstadoMadre;
                this.txtNacionalidadMadre.Value = datosGeneralesDTO.NacionalidadMadre;
                this.txtPasaporteMadre.Value = datosGeneralesDTO.PasaporteMadre;
                this.txtNombrePadre.Value = datosGeneralesDTO.NombrePadre;
                this.txtRutPadre.Value = datosGeneralesDTO.RutPadre;
                this.txtDireccionPadre.Value = datosGeneralesDTO.DireccionPadre;
                this.txtEstadoPadre.Value = datosGeneralesDTO.EstadoPadre;
                this.txtNacionalidadPadre.Value = datosGeneralesDTO.NacionalidadPadre;
                this.txtPasaportePadre.Value = datosGeneralesDTO.NumPasaportePadre;
                this.txtComunaResidencia.Value = datosGeneralesDTO.ComunaResidente;
                this.txtAyudaComunal.Value = datosGeneralesDTO.CualAyudaComunal;
                this.txtCuales.Value = datosGeneralesDTO.CualAyudaComunal;
                this.txtApoyoComunitario.Value = datosGeneralesDTO.ApoyoComunitario;
                this.txtChileSolidario.Value = datosGeneralesDTO.ChileSolidario;
        ...
        private void CargarAntecedentesSalud(string codNino)
        {
            ...
            if (antecedentesSaludDTO != null)
            {
                ...
                this.txtCronica.Value = antecedentesSaludDTO.EnfermedadCronica;
                this.txtTratamiento.Value = antecedentesSaludDTO.RecibeTratamiento;                
                this.txtSaludMental.Value = antecedentesSaludDTO.ProblemaSaludMental;
                this.txtDiagnosticado.Value = antecedentesSaludDTO.Diagnosticado;
                this.txtTratamientoDiagnostico.Value = antecedentesSaludDTO.TratamientoDiagnostico;
                this.txtTieneDiscapacidad.Value = antecedentesSaludDTO.TieneDiscapacidad;
                this.txtTratadoPor.Value = antecedentesSaludDTO.TratadoPor;
                this.txtTratamientoDiscapacidad.Value = antecedentesSaludDTO.RecibeTratamientoDis;
                this.txtRegistroDiscapacidad.Value = antecedentesSaludDTO.RegistroDiscapacidad;
