            ...
            <div class="row yellow-border">
                ...
                <div class="row" id="divTabla">
                    ...
                    <div class="table-bordered">                       
                        <table id="FichaIndividualResultadosBusqueda" class="table table-responsive cell-border table-hover" style="width: 100%; font-size: 12px;">
                            <thead>
                                <tr>
                                    <th class="colmidgene hcol textauto" style="font-size: 12px; height: 10px !important;">Nombre</th>
                                    <th class="colmidgene hcol textauto" style="font-size: 12px; height: 10px !important;">Rut o N° Pasaporte</th>
                                    <th class="colmidgene hcol" style="width:90px !important; "></th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
