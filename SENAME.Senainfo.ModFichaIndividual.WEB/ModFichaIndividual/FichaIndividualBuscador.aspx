...
<html lang="es">
  ...
  <link rel="stylesheet" href="../Content/css/FI_Diseño.css" />
              ...
              <div class="input-group">
                ...
                <div class="input-group-btn">
                  <button
                    ...
                    aria-expanded="false"
                    id="botoninst"
                    style="font-size: 12px !important;"> <img src="../images/pregunta_12png.png">
                  </button>
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li>
                      <a href="#"> Información <br />Seleccione una Institución </a>
                    </li>
                  </ul>
                </div>
                <!-- /btn-group -->
            ...
            <div class="col-xs-12 col-md-9 mytop1">
              <div class="input-group">
                ...
                <div class="input-group-btn">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li>
                      <a href="#"> Información <br />Seleccione un Proyecto </a>
                    </li>
                  </ul>
                </div>
                <!-- /btn-group -->
